...
export const Notifier = () => {
    ...
    return (
        <div className='flex flex-row gap-1 items-center'>
                ...
                {!isLoading ? <p className={twMerge('flex flex-row items-center transition-all w-0 h-8 overflow-hidden text-nowrap', overNotifications && 'w-48')}>Get notified of new blogs!</p> : <img src={logo} className="animate-spin w-4" />}
        </div>
    );
}