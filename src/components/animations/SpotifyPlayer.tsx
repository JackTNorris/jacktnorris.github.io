...
export const SpotifyPlayer = () => {
    ...
    return (
        <div className="md:flex flex-col gap-3 w-36 hidden md:visible">
            <p className="press-start text-xs">What I'm Listening To:</p>
            <div className="h-24 w-24">
                <img className={twMerge("transition-all absolute mt-2 h-20 w-20", hoverRecord && 'ml-16 animate-spin')} src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/LP_Vinyl_Symbol_Icon.png/1200px-LP_Vinyl_Symbol_Icon.png" />
