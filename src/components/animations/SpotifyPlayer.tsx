...
export const SpotifyPlayer = () => {
    ...
    return (
        <div className="md:flex flex-col gap-3 w-48 h-48 hidden md:visible items-start">
            ...
            <div className="h-24 w-24">
                    <div className={twMerge('transition-all absolute flex flex-row items-center', hoverRecord && 'ml-14')}>
                        <img className={twMerge("transition-all mt-2 h-28 w-28", hoverRecord && 'animate-spin')} src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/LP_Vinyl_Symbol_Icon.png/1200px-LP_Vinyl_Symbol_Icon.png" />
