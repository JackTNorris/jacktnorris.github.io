...
export const TopicSelector = ({onSelectTopic, topics, defaultTopic}: TopicSelectorProps) => {
    const [isOpen, setIsOpen] = useState(false)
    const [currTopic, setCurrTopic] = useState(defaultTopic ? defaultTopic : '🕊️ peace corps')
